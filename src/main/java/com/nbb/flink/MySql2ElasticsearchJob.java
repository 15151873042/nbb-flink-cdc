...
import com.nbb.flink.sink.NbbElasticsearchSink;
...
public class MySql2ElasticsearchJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        mysqlDataSource.sinkTo(NbbElasticsearchSink.newSink(new HttpHost("127.0.0.1", 9200, "http")));
